//
// INCREASED RX BUFFER FROM 128 TO 256
// SEARCH FOR "/***CHANGED***/" TO FIND THE MODIFIED PARTS
//
//*****************************************************************************
//
...
#define UART_RX_BUFFER_SIZE     256  /***CHANGED***/
#endif
...
//
//*****************************************************************************
extern volatile uint32_t systick1, systick2, diff;
